    ...
    try:
        ...
        if db.query(FaultScenario).count() == 0:
            ...
            default_faults = [
                ...
                FaultScenario(
                    name="Nginx连接数溢出",
                    fault_type="nginx_connection_overflow",
                ...
                FaultScenario(
                    name="Nginx上游超时",
                    fault_type="nginx_upstream_timeout",
                    target_component_type="nginx",
                ...
                FaultScenario(
                    name="Redis连接池耗尽",
                    fault_type="redis_connection_exhaust",
                ...
                FaultScenario(
                    name="Redis内存溢出",
                    fault_type="redis_memory_overflow",
                    target_component_type="redis",
                ...
                FaultScenario(
                    name="MySQL连接池耗尽",
                    fault_type="mysql_connection_exhaust",
                ...
                FaultScenario(
                    name="API网关熔断",
                    fault_type="api_gateway_circuit_break",
                ...
                FaultScenario(
                    name="API网关限流",
                    fault_type="api_gateway_rate_limit",
                    target_component_type="api_gateway",
                ...
                FaultScenario(
                    name="防火墙规则阻断",
                    fault_type="firewall_rule_block",
